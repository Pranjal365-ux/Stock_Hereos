...
export default function RewardScreen({ onContinue, cashEarned }: RewardScreenProps) {
  return (
    <div className="screen-bg min-h-screen flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <div className="balance-card p-8 mb-4">
          <p className="mb-2" style={{color:'rgba(223,182,178,0.6)', fontSize:'0.9rem'}}>Quiz bonus earned</p>
          <h2 className="text-4xl mb-2" style={{
            background:'linear-gradient(135deg, #4ade80, #22c55e)',
            WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text',
            filter:'drop-shadow(0 0 10px rgba(34,197,94,0.4))'
          }}>+₹{cashEarned.toLocaleString('en-IN')}</h2>
          <p style={{color:'rgba(223,182,178,0.6)', fontSize:'0.9rem'}}>added to your virtual balance!</p>
        </div>
